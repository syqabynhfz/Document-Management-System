        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-4">
                    ...
                    >
                        Manajemen Tipe Dokumen (Master Doc)
                    </h3>
                    <Link
                        :href="route('master-doc.create')"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr v-for="docType in docTypes" :key="docType.id">
                            ...
                            >
                                <Link
                                    :href="route('master-doc.edit', docType.id)"
                                    class="text-indigo-600 hover:text-indigo-900"
                                    >Edit</Link
                                >
                                <Link
                                    :href="
                                        route('master-doc.destroy', docType.id)
                                    "
                                    method="delete"
                                    as="button"
                                    class="text-red-600 hover:text-red-900"
                                    onclick="return confirm('Apakah Anda yakin ingin menghapus tipe dokumen ini?')"
                                >
                                    Hapus
                                </Link>
                            </td>
